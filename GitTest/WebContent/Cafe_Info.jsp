...
<body class="u-body">
	<header class="u-clearfix u-header u-header" id="sec-d37f">
		<div class="u-clearfix u-sheet u-sheet-1">
			<%CafeDTO inf = (CafeDTO) session.getAttribute("inf");%>
			<%PicDTO pic = (PicDTO) session.getAttribute("pic");%>
			
			<a href="Home.jsp" data-page-id="654928509"
				class="u-image u-logo u-image-1" data-image-width="1685"
				data-image-height="690" title="Home"> <img src="images/_.png"
				...
				<div class="u-custom-menu u-nav-container">
					<ul class="u-nav u-unstyled u-nav-1">
						<li class="u-nav-item"><a
							class="u-button-style u-nav-link u-text-active-custom-color-4 u-text-hover-palette-2-base"
							href="Home.jsp" style="padding: 10px 20px;">Home</a></li>
						<li class="u-nav-item"><a
							class="u-button-style u-nav-link u-text-active-custom-color-4 u-text-hover-palette-2-base"
							href="Post.jsp" style="padding: 10px 20px;">Post</a></li>
						<li class="u-nav-item"><a
							class="u-button-style u-nav-link u-text-active-custom-color-4 u-text-hover-palette-2-base"
							href="Login.jsp" style="padding: 10px 20px;">Login</a>
						<div class="u-nav-popup">
								<ul
									class="u-h-spacing-20 u-nav u-unstyled u-v-spacing-10 u-nav-2">
									<li class="u-nav-item"><a
										class="u-button-style u-custom-color-10 u-nav-link u-text-active-custom-color-4"
							...
							<ul
								...
								<div class="u-nav-popup">
										<ul
											...
											<li class="u-nav-item"><a
												class="u-button-style u-nav-link" href="Join.jsp">Join</a></li>
										</ul>
									</div></li>
							</ul>
						</div>
			...
			<span class="u-icon u-icon-circle u-text-custom-color-2 u-icon-1"
				data-href="My_Page.jsp" data-page-id="195028572"><svg
					class="u-svg-link" preserveAspectRatio="xMidYMin slice"
					viewBox="0 0 415.744 415.744" style="">
					<use xmlns:xlink="http://www.w3.org/1999/xlink"
						xlink:href="#svg-0149"></use></svg>
				<svg class="u-svg-content" viewBox="0 0 415.744 415.744" x="0px"
					y="0px" id="svg-0149"
					style="enable-background: new 0 0 415.744 415.744;">
					<g>
					<g>
					<path
						d="M207.872,0c-53.76,0-97.28,43.52-97.28,97.28s43.52,97.28,97.28,97.28s97.28-43.52,97.28-97.28S261.632,0,207.872,0z"></path>
</g>
</g>
					<g>
					<g>
					<path
						d="M245.76,205.824h-75.776c-76.288,0-138.24,61.952-138.24,138.24v56.32c0,8.704,6.656,15.36,15.36,15.36H368.64    c8.704,0,15.36-6.656,15.36-15.36v-56.32C384,267.776,322.048,205.824,245.76,205.824z"></path>
</g>
</g></svg></span>
		</div>
	</header>
								...
								<div class="u-tab-links-align-justify u-tabs u-tabs-1">
									...
									<div class="u-tab-content">
											...
											<div class="u-container-layout u-container-layout-2">
												<table border="1">
													<tr>
														...
														<td rowspan ="9" width="300px" ><img src="<%=pic.getPic_path()%>"> </td>
													</tr>
													<tr>
													<td><br></td>
													</tr>
										...
										<div
											...
											id="tab-8453" role="tabpanel" aria-labelledby="link-tab-8453">
											<div
										...
										<div class="u-container-style u-tab-pane u-white u-tab-pane-3"
											id="tab-c8f5" role="tabpanel" aria-labelledby="link-tab-c8f5">
