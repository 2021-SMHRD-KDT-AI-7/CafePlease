...
<link rel="stylesheet" href="Cafe_cj.css" media="screen">
  ...
  <!--   <script class="u-script" type="text/javascript" src="nicepage.js" defer=""></script> -->
    ...
    <meta property="og:title" content="Cafe_cj">
...
<!-- 새로만든 헤더부분 끝 -->
    <section class="u-clearfix u-section-1" id="sec-e384">
      <div class="u-clearfix u-sheet u-sheet-1">
        <h2 class="u-align-center u-text u-text-custom-color-2 u-text-1">젊음의 열기가 느껴지는<br>
          <span class="u-text-custom-color-5">충장로</span>에 있는 카페에요!
        </h2>
        ...
        <%
			...
			ArrayList<CafeImagesDTO> i_list = dao.ViewImages_CJ();
          ...
          <% for(int i = 0; i<i_list.size(); i++){ %>  
            ...
            <div class="u-effect-fade u-gallery-item u-gallery-item-1">
              <div class="u-back-slide" data-image-width="828" data-image-height="823">
                <img class="u-back-image u-expanded" src="<%= i_list.get(i).getPic_path() %>" alt="D02<%= i+1 %>.jpg">
              </div>
