  ...
  <body class="u-body">
	...
	<section class="u-clearfix u-section-1" id="sec-e384">
      <div class="u-clearfix u-sheet u-sheet-1">
        ...
        <h6 class="u-text u-text-custom-color-2 u-text-2">#용전동</h6>
        <h6 class="u-text u-text-custom-color-2 u-text-3">#운암동</h6>
        <h6 class="u-text u-text-custom-color-2 u-text-4">#전남대</h6>
        ...
        <div class="u-gallery u-layout-grid u-lightbox u-show-text-on-hover u-gallery-1" id="carousel-185d">
         ...
         <% ArrayList<CafeImagesDTO> i_list_P01 = new ArrayList<CafeImagesDTO>(); 
          for(int i = 0; i<i_list.size(); i++){
        	  if (i_list.get(i).getPic_id().contains("P01")) { 
					i_list_P01.add(i_list.get(i)); %>  
