...
<link rel="stylesheet" href="Cafe_N.css" media="screen">
   ...
   <!--<script class="u-script" type="text/javascript" src="nicepage.js" defer=""></script>  --> 
    ...
    <meta property="og:title" content="Cafe_N">
    ...
    <section class="u-clearfix u-section-1" id="sec-e384">
      <div class="u-clearfix u-sheet u-sheet-1">
        <h2 class="u-align-center u-text u-text-custom-color-2 u-text-1">청명한 가을날 가기 좋은<br>
          <span class="u-text-custom-color-5">남구</span>에 있는 카페에요!
        </h2>
        ...
        <h6 class="u-text u-text-custom-color-2 u-text-3">#양림동</h6>
        <h6 class="u-text u-text-custom-color-2 u-text-4">#봉선동</h6>
        
        <%
         CafeImagesDAO dao = new CafeImagesDAO();
		 ArrayList<CafeImagesDTO> i_list = dao.ViewImages_N();
          ...
          <div class="u-gallery-inner u-gallery-inner-1" role="listbox">
            ...
            <div class="u-effect-fade u-gallery-item u-gallery-item-1">
              <div class="u-back-slide" data-image-width="828" data-image-height="823">
                <img class="u-back-image u-expanded" src="<%= i_list.get(i).getPic_path() %>" alt="N<%= i+1 %>.jpg">
              </div>
