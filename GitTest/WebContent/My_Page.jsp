...
<body class="u-body">
		...
		<header>
			...
			<div id="top_menu">
				<%
					if (info != null) {
				%>
				<b id="user_id"> <%=info.getM_nickname()%>님 환영합니다
				</b>
				<%
					}
				%>
 ...
 %>
			...
			<div
				...
				<ul class="u-spacing-30 u-tab-list u-unstyled tabs" role="tablist">
					<li class="u-tab-item" role="tab" id="link-tab-3a42"
						aria-controls="tab-3a42" aria-selected="true" tabindex="0">내가쓴 게시글 관리</li>
				...
				<div class="u-tab-content">
					...
					<div
						...
						<div class="u-container-layout u-container-layout-9">
							<p class="u-custom-font u-heading-font u-large-text u-text u-text-variant u-text-9" >변경하실
								정보를 입력해주세요</p>
							...
							<div class="u-form u-form-21" style="margin-top: 40px;">
								<form action="MemberUpdateCon" method="POST"
									...
									<div class="u-form-group u-form-group-4">
										...
										<input type="text" placeholder="비밀번호를 한 번더 입력해주세요"
									...
									<div class="u-align-center u-form-group u-form-submit">
										<input type="submit"
											class="u-border-none u-btn u-btn-submit u-button-style u-custom-color-4 u-hover-palette-1-dark-1 u-btn-8" value="수정"><br>
	...
	/* 	function eventHandler(e) {
			...
			.siblings('[role="tab"]').attr('aria-selected', false).removeClass('active'); // 구버전 IE

			$targetPanel.attr('aria-hidden', false).addClass('active') // 구버전 IE
